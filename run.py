...
async def main():
    ...
    gw, mac = "192.168.110.1", "d4:29:a7:47:b9:9b" # Default values
    ...
    print(f"[+] Portal Opened (GW: {gw})")
    try: 
        if 'm2' in globals() or 'm2' in locals():
            print("[*] Running M2 Core...")
            # m2 ထဲက run ဆိုတဲ့ function ရှိရင် ခေါ်သုံးဖို့ ကြိုးစားပါမယ်
